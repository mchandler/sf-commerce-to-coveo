...
// Salesforce field API names for the 32 extended-attribute Coveo fields.
//
...
const PRODUCT2_FIELDS = {
  ...
  ec_door_height:           'Door_Height__c',
  ec_door_unit_size:        'Door_Unit_Size__c',
  ec_door_width:            'Door_Width__c',
  ec_fastener_type:         'Fastener_Type__c',
  ec_insect_screen_height:  'Insect_Screen_Height__c',
  ec_insect_screen_type:    'Insect_Screen_Type__c',
  ec_insect_screen_width:   'Insect_Screen_Width__c',
  ec_install_method:        'Install_Method__c',
  ec_part_size:             'Part_Size__c',
  ec_product_style:         'Product_Style__c',
  ec_series:                'Series__c',
  ec_thickness:             'Thickness__c',
  ec_vintage:               'Vintage__c',
  ec_window_unit_size:      'Window_Unit_Size__c',
